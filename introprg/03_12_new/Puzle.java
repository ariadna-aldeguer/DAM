/* Puzle: Funcio new.
 * Crear un puzle en blanc amb el nom del fitxer donat. 
 */
...
public class Puzle {
    ...
    /**
     * Processa la comanda duplicar
     * @param nomOrigen nomDesti : donat dos noms de puzles, es copiar el primer al segon.
     */
    
    public static void duplicaPuzle(String nomOrigen, String nomDesti) throws IOException{
    
        String camiOrigen = String.format("puzle_%s.txt", nomOrigen);
        String camiDesti = String.format("puzle_%s.txt", nomDesti);
