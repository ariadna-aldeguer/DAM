/* Puzle: Funcio eliminar figura.
 * Eliminara una figura a un puzle existent donada la posicio d'origen i de destí
 * sempre que no estigui buida. 
 */
...
public class Puzle {
    ...
    //del[0] «nom»[1] «fila»[2] «columna»[3]
        ...
        int fila = Integer.parseInt(String.valueOf(args[2]));
        int columna = Integer.parseInt(String.valueOf(args[3]));
        if ( Escacs.eliminaFigura(taulell, fila, columna)){
            escriuPuzle(args[1], taulell);
            return;
        } else {
